...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const VALID_VIEWS: ActiveView[] = [
    'landing', 'explore-path', 'inner-shift', 'inner-revolution', 'career-axis', 'career-axis-booking', 'corporate-wellness', 'partner-with-us',
  ...
  const [activeView, setActiveViewRaw] = useState<ActiveView>(() => {
    try {
      ...
      if (hash && ['landing', 'explore-path', 'inner-shift', 'inner-revolution', 'career-axis', 'career-axis-booking', 'corporate-wellness', 'partner-with-us', 'dashboard', 'challenge', 'breathing', 'meditation', 'sound-therapy', 'journal', 'mood', 'upgrade', 'profile', 'ai-coach', 'cbt-video', 'success'].includes(hash)) {
        return hash;
      }
    } catch (e) {
      console.error(e);
