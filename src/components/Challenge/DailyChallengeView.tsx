...
import { Cbt12TechniquesVideo } from '../CbtVideo/Cbt12TechniquesVideo';
...
export const DailyChallengeView: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 animate-fadeIn pb-24">
      ...
      {/* SECTION 2: 10-MINUTE ANIMATED CBT STRESS RELEASE VIDEO */}
      <ScrollReveal variant="slide-up">
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-amber-500/10 via-emerald-500/10 to-transparent p-4 rounded-2xl border border-amber-300/40 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-gradient-to-r from-[#D4AF37] to-amber-500 text-slate-950 rounded-xl font-bold">
                <Video className="w-5 h-5" />
              </div>
              <div>
                <span className="text-[10px] uppercase font-extrabold tracking-wider text-[#0B6B53] bg-emerald-100 px-2 py-0.5 rounded">
                  STEP 2 (RECOMMENDED AFTER SOMATIC ORIENTATION)
                </span>
                <h3 className="font-heading font-bold text-slate-900 text-base">
                  5 CBT Techniques to Instantly Release Stress (10-Min Video)
                </h3>
              </div>
            </div>
            <span className="hidden sm:inline-block text-xs font-bold bg-[#D4AF37] text-slate-950 px-3 py-1 rounded-full">
              10 Mins Masterclass
            </span>
          </div>

          <Cbt12TechniquesVideo />
        </div>
      </ScrollReveal>

      {/* SECTION 3: MEDITATION AUDIO PLAYER */}
      <ScrollReveal variant="slide-up">
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-heading font-bold text-xl text-slate-900">
                  Step 3: Day {dayData.dayNumber} {dayData.title} Meditation ({dayData.meditationTrack.soundName})
                </h2>
      ...
      {/* SECTION 5: JOURNAL REFLECTION & MOOD TRACKER */}
      <ScrollReveal variant="slide-up">
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              <h2 className="font-heading font-bold text-xl text-slate-900">
                Step 5: Daily Reflection & Mood Tracker
              </h2>
              <p className="text-xs text-slate-500">
