...
export const INNER_REVOLUTION_PROGRAMS: InnerRevolutionProgramItem[] = [
  {
...
export const InnerRevolutionView: React.FC = () => {
  ...
  return (
    <div id="inner-revolution-page" className="min-h-screen bg-white text-slate-900 pb-20 font-sans">
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-10 px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-extrabold text-[#C89620] tracking-tight text-left">
