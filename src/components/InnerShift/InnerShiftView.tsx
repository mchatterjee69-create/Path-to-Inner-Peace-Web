...
const SERVICE_SECTIONS: ServiceCardItem[] = [
  {
    id: 'stress-relief',
...
// ==========================================
// 2. INNER REVOLUTION PROGRAM DATA
// ==========================================
...
export const InnerShiftView: React.FC = () => {
  ...
  // Smooth scroll to targeted section based on active view navigation
  useEffect(() => {
    if (activeView === 'inner-revolution') {
      const el = document.getElementById('inner-revolution-section');
      if (el) {
        el.scrollIntoView({ behavior: 'smooth' });
      }
    } else if (activeView === 'career-axis') {
      const el = document.getElementById('career-axis-section');
      if (el) {
        el.scrollIntoView({ behavior: 'smooth' });
      }
    } else if (activeView === 'inner-shift') {
      const el = document.getElementById('inner-shift-section');
      if (el) {
        el.scrollIntoView({ behavior: 'smooth' });
      }
    }
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 pb-24 font-sans selection:bg-[#0B6B53] selection:text-white">
      
      {/* =========================================================================
          PART 1: INNER SHIFT (PAGE 1)
      ========================================================================= */}
      <section id="inner-shift-section" className="pt-8 sm:pt-12 pb-14 sm:pb-20 border-b border-slate-200">
        <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            {SERVICE_SECTIONS.map((item, index) => {
      ...
      ========================================================================= */}
      <section id="inner-revolution-section" className="pt-12 sm:pt-16 pb-14 sm:pb-20 border-b border-slate-200">
      ...
      ========================================================================= */}
      <section id="career-axis-section" className="pt-12 sm:pt-16 pb-12">
      ...
      {/* =========================================================================
          FLOATING CHAT BUTTON & QUICK INQUIRY MODAL (CAREER AXIS)
      ========================================================================= */}
