...
import { CheckCircle2, Lock, ArrowRight, Flame, Clock } from 'lucide-react';
...
export const ChallengeOverview: React.FC = () => {
  ...
  return (
    <section id="curriculum-section" className="pt-20 pb-8 px-4 sm:px-6 lg:px-8 bg-slate-50 border-t border-slate-200 overflow-hidden">
            ...
            return (
              <StaggerItem key={day.dayNumber} variant="scale">
                <div
                  ...
                  className={`relative rounded-2xl p-5 border transition-all cursor-pointer flex flex-col justify-between h-full ${
                    isCompleted 
