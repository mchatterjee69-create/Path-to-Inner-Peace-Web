...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#041F18] via-[#083D30] to-[#0D4D3E] text-white pt-16 sm:pt-20 pb-24 sm:pb-28 px-4 sm:px-6 lg:px-8">
