      ...
      <div className="max-w-[1600px] mx-auto px-2 sm:px-3 lg:px-4 h-16 sm:h-20 flex items-center justify-between gap-1 lg:gap-2">
        ...
        >
          <img 
            ...
            className="w-8 h-8 sm:w-9 sm:h-9 xl:w-10 xl:h-10 rounded-full object-cover shadow-sm group-hover:scale-105 transition-transform shrink-0 border border-emerald-800/10"
            referrerPolicy="no-referrer"
          />
          <div className="flex flex-col min-w-0">
            <span className="font-poppins font-bold text-sm sm:text-base xl:text-lg text-[#0B6B53] tracking-tight whitespace-nowrap leading-tight">
              Path to Inner Peace
            </span>
            <span className="text-[9px] sm:text-[10px] xl:text-xs font-semibold gold-text tracking-normal whitespace-nowrap leading-none mt-0.5">
              Transform Your Mind
            </span>
          </div>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-1.5 xl:gap-3 2xl:gap-4 font-inter text-xs xl:text-sm font-medium text-emerald-900/90 whitespace-nowrap shrink min-w-0">
          <button
            onClick={() => setActiveView('landing')}
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'landing' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'inner-shift' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'inner-revolution' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'career-axis' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'dashboard' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'ai-coach' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
            <Compass className="w-3.5 h-3.5 xl:w-4 xl:h-4 text-[#0B6B53] shrink-0" />
          ...
          <button
            ...
            className={`transition-colors py-1 px-1 xl:px-1.5 flex items-center gap-1 whitespace-nowrap ${activeView === 'profile' ? 'text-emerald-950 font-bold border-b-2 border-[#0B6B53]' : 'hover:text-emerald-950'}`}
          >
